                        ...
                        return (
                            <Output
                                ...
                                <div className='flex items-start justify-center gap-2'>
                                    ...
                                    <div id="Delete">
                                        <FontAwesomeIcon icon={faTrash} className='bg-black cursor-pointer p-2 rounded-full text-white text-lg' onClick={() =>handleDelete(Project._id)} />
                                    </div>
                                    <div id="Archive">
                                        <FontAwesomeIcon icon={faBoxArchive} className='bg-black cursor-pointer p-2 rounded-full text-lg text-white' onClick={() => handleArchive(Project._id)} />
                                    </div>
                                </div>
                                </div>
                                }
